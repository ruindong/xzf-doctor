...
Page({
  ...
  onLoad:function(options){
    var that = this;
    that.GetLabelList();//加载GetProTypeList类别
  ...
  GetLabelList:function(){//加载GetProTypeList类别
    var that = this;
    ...
    send_ajax._get("xiuxiu.ashx?action=GetLabelList&parent_id=0",{},function(res){
        ...
        console.log(that.data.GetProTypeList)
    },function(){})
  },
  GetPostList:function(){//列表
    ...
    send_ajax._get("xiuxiu.ashx?action=GetPostList",data,function(res){
        ...
        that.setData({resultData:resultDataNew,totalPages:res.Data.TotalPages,lowerFooter:false})
    },function(){})
  },
  addmore:function(){
     var that = this;
